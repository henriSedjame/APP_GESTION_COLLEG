...
public class ClassTest {
    ...
    public void eleve() throws ParseException {
        ...
        Adresse adresse14 = new Adresse( "10 rue des poilus", "33000",
                "Bordeaux" );
        Adresse adresse15 = new Adresse( "28 fbg de la cueille", "33000",
                "Bordeaux" );
        ...
        Identifiant id15 = new Identifiant( "HSedjame", "Hs!870214" );
        ...
        Identite petitPId = new Identite( Civilite.MLLE, "Petit-Papier",
                ...
                adresse14, id14 );
        Identite HenriId = new Identite( Civilite.MR, "Sedjame",
                "Henri", sdf.parse( "14/02/1987" ),
                adresse15, id15 );
        ...
        Eleve henri = new Eleve( "HS870214" );
        henri.setIdentite( HenriId );
        henri.setClasse( sixieme );
        ...
        eleveDao.create( henri );

        List<Eleve> eleves = eleveDao.findByClasse( sixieme );

        Assert.assertEquals( 1, eleves.size() );
